...
cc_all <- read.csv("/n/netscratch/menzies_lab/Lab/Allison/EquityV2/data/cc_all_10pct.csv",header=TRUE,check.names=FALSE)
oop_all <- read.csv("/n/netscratch/menzies_lab/Lab/Allison/EquityV2/data/oop_all_10pct.csv",header=TRUE,check.names=FALSE)
...
# calc all results then separate step for summary statistics
  ...
  write.csv(output_all,paste0("/n/netscratch/menzies_lab/Lab/Allison/EquityV2/output/",i,"_equity_10pct.csv"),row.names=FALSE)
  rm(output)
